...
namespace AptCare.Repository.Migrations
{
    ...
    [Migration("20251213155810_RemoveInvoiceAccessoryUniqueConstraint")]
    partial class RemoveInvoiceAccessoryUniqueConstraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AptCare.Repository.Entities.AccessoryStockTransaction", b =>
                {
                    ...
                    b.ToTable("AccessoryStockTransactions");
                });
            ...
            modelBuilder.Entity("AptCare.Repository.Entities.InvoiceAccessory", b =>
                {
                    ...
                    b.HasIndex("InvoiceId", "AccessoryId", "SourceType")
                        .IsUnique();
            ...
            modelBuilder.Entity("AptCare.Repository.Entities.AccessoryStockTransaction", b =>
                {
                    ...
                    b.HasOne("AptCare.Repository.Entities.User", "ApprovedByUser")
                        .WithMany("ApprovedStockTransactions")
                        .HasForeignKey("ApprovedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AptCare.Repository.Entities.User", "CreatedByUser")
                        .WithMany("CreatedStockTransactions")
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AptCare.Repository.Entities.Invoice", "Invoice")
                        .WithMany("AccessoryStockTransactions")
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("AptCare.Repository.Entities.Transaction", "Transaction")
                        .WithMany()
            ...
            modelBuilder.Entity("AptCare.Repository.Entities.Invoice", b =>
                {
                    b.Navigation("AccessoryStockTransactions");
            ...
            modelBuilder.Entity("AptCare.Repository.Entities.User", b =>
                {
                    ...
                    b.Navigation("ApprovedStockTransactions");

                    b.Navigation("ConversationParticipants");

                    b.Navigation("CreatedStockTransactions");
